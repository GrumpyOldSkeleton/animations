...
class Looper():
    ...
    def __init__(self):
        ...
        self.noise_smoothness   = 20 # this defines how smooth the randomness is
    ...
    def draw(self):
        ...
        for a in range(0, numpoints):
            ...
            nx = (self.noise.noise2d(pathx + circle_x / self.noise_smoothness, pathx + circle_y / self.noise_smoothness)) * random_effect
            ny = (self.noise.noise2d(pathy + circle_x / self.noise_smoothness, pathy + circle_y / self.noise_smoothness)) * random_effect
